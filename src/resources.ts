...
export const resources = new Map<ResourceType, IResource>([
  [ResourceType.Module, {
    ...
    files: [{ name: config => `-routing.module.ts`, type: TemplateType.ModuleRouting, condition: (config, params) => config.defaults.module.routing },
    ...
    { name: config => `type.ts`, type: TemplateType.Type},
